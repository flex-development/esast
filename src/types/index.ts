...
export type { default as Comments } from './comments'
export type { default as Decorators } from './decorators'
export type { default as EcmaVersion } from './ecma-version'
export type { default as EmptyChildren } from './empty-children'
export type { default as CommentKind } from './kind-comment'
export type { default as ExportKind } from './kind-export'
...
export type { default as UnaryTypeOperator } from './operator-unary-type'
export type { default as UpdateOperator } from './operator-update'
export type { default as PropertyName } from './property-name'
export type { default as SourceMode } from './source-mode'
export type { default as ModifierValue } from './value-modifier'
export type { default as TypeKeywordValue } from './value-type-keyword'
