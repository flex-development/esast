...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/esast
   cd esast
   ```
...
```sh
https://github.com/flex-development/esast/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/esast/discussions/new?category=q-a
